...
<template>
  <el-row class="my-row">
    <el-col>
      <p>
        阶段/期末：在课程名称后追加`阶段/期末`，监考老师相互协调派研究生；
        <br />
        绿色区域：课程名称，地点，人数，必填；
        <br />
        ...
        <br />
        表格中日期请使用文本类型，不要使用日期时间类型；
        <br />
        支持多种日期时间组合模式，数字自动补位/中英文符号替换等；
        <br />
        <img src="@/assets/timeformat.png" width="500px" />
      </p>
    </el-col>

    <el-col :span="12">
      <input type="file" @change="readInvis" accept=".xlsx, .xls" />
